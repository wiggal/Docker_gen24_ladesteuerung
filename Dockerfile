...
# folgedes beseitigt die Warnung: apache2: Could not reliably determine the server's fully qualified domain name 
...
CMD /etc/init.d/apache2 restart && \
    crontab -u www-data /var/tmp/www-data && \
    /etc/init.d/cron restart && \
    chown -R www-data:www-data /home/GEN24/ && \
